...
<body>
    ...
    <tr align="center" valign="middle"> 
        <td colspan="5"> 
            <font size=2> 
                <a href="./BoardReplyAction.bo?num=<%=board.getBOARD_NUM() %>"><img src="images/btn_r.png"></a> 
                <a href="./BoardModify.bo?num=<%=board.getBOARD_NUM() %>"><img src="images/btn_e.jpg"></a>                 
                <a href="./BoardDelete.bo?num=<%=board.getBOARD_NUM() %>"><img src="images/btn_d1.jpg"></a> 
                <a href="./BoardList.bo"><img src="images/btn_l.jpg"></a>                 
            </font> 
        </td> 
    </tr> 
 </table> 
