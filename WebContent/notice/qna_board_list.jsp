...
<div class="wrap">
	...
	<div class="pagination">
            ...
            <%if(nowpage<=1){ %> <a href ="./NoticeList.bo?page=<%=nowpage-1%>" class="direction"><span>Prev</span>
            </a>&nbsp;         
            <%}else{ %> 
                <a href ="./NoticeList.bo?page=<%=nowpage-1%>">Prev</a>&nbsp; 
            <%} %> 
             
            <%for(int a=startpage ; a<=endpage ; a++){  
                    if(a==nowpage){ %>  
                       <a href="./NoticeList.bo?page=<%=a %>"><strong><%=a%></strong></a>&nbsp;  
               <%}else{ %> 
                <a href="./NoticeList.bo?page=<%=a %>"><strong><%=a%></strong></a>&nbsp; 
                <%} %> 
             <%} %>  
              
             <%if(nowpage>=maxpage){ %> <a href ="./NoticeList.bo?page=<%=nowpage+1%>" class="direction"><span>Next</span>
             </a>
            <%}else{ %> 
                <a href ="./NoticeList.bo?page=<%=nowpage+1%>">Next</a> 
            <%} %>
   ...
   <tr align="right"> 
        <td colspan="5"> 
			<% String boardsubject = request.getParameter("board_subject1"); %>    
        		...
        		<a href="./NoticeWrite.bo"><img src="./images/btn_m.jpg"></td></a>
        		<%} %>
        		</form>
    </tr> 
