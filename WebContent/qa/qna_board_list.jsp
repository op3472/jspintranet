...
<div class="wrap">
	...
	<div class="pagination">
            ...
            <%if(nowpage<=1){ %> <a href ="./QAList.bo?page=<%=nowpage-1%>" class="direction"><span>Prev</span>
            </a>&nbsp;         
            <%}else{ %> 
                <a href ="./QAList.bo?page=<%=nowpage-1%>">Prev</a>&nbsp; 
            <%} %> 
             
            <%for(int a=startpage ; a<=endpage ; a++){  
                    if(a==nowpage){ %>  
                       <a href="./QAList.bo?page=<%=a %>"><strong><%=a%></strong></a>&nbsp;  
               <%}else{ %> 
                <a href="./QAList.bo?page=<%=a %>"><strong><%=a%></strong></a>&nbsp; 
                <%} %> 
             <%} %>  
              
             <%if(nowpage>=maxpage){ %> <a href ="./QAList.bo?page=<%=nowpage+1%>" class="direction"><span>Next</span>
             </a>
            <%}else{ %> 
                <a href ="./QAList.bo?page=<%=nowpage+1%>">Next</a> 
            <%} %>
        ...
        <td colspan="5"> 
			<% String boardsubject = request.getParameter("board_subject1"); %>    
        		<form action="./QAList2.bo?page=<%=nowpage%>" method="POST">
     			...
     			<a href="./QAWrite.bo"><img src="./images/btn_m.jpg"></td></a>
