...
<div class="wrap">
	...
	<div class="pagination">
            ...
            <%if(nowpage<=1){ %> <a href ="./BoardList.bo?page=<%=nowpage-1%>" class="direction"><span>Prev</span>
            </a>&nbsp;         
            <%}else{ %> 
                <a href ="./BoardList.bo?page=<%=nowpage-1%>">Prev</a>&nbsp; 
            <%} %> 
             
            <%for(int a=startpage ; a<=endpage ; a++){  
                    if(a==nowpage){ %>  
                       <a href="./BoardList.bo?page=<%=a %>"><strong><%=a%></strong></a>&nbsp;  
               <%}else{ %> 
                <a href="./BoardList.bo?page=<%=a %>"><strong><%=a%></strong></a>&nbsp; 
                <%} %> 
             <%} %>  
              
             <%if(nowpage>=maxpage){ %> <a href ="./BoardList.bo?page=<%=nowpage+1%>" class="direction"><span>Next</span>
             </a>
            <%}else{ %> 
   ...
   <tr align="right"> 
        <td colspan="5"> 
			<% String boardsubject = request.getParameter("board_subject1"); %>    
        		...
        		<a href="./BoardWrite.bo"><img src="images/btn_m.jpg"></td></a>
        		</form>
    </tr> 
