...
<meta http-equiv="Content-Type" content="text/html; charset=EUC-KR">
    ...
    <script type="text/javascript">
        ...
        function checkValue()
        {
            ...
            // 전송할 값을 변수에 담는다.    
            var comment_num = "${comment.lecture_num}";
            ...
            if(!comment_content)
            {
                ...
                httpRequest.open("POST", "CommentUpdateAction.le", true);    
...
<div id="wrap">
    ...
    <div id="commentUpdateForm">
        <form name="updateInfo" target="parentForm">        
            <textarea rows="7" cols="70" name="comment_content">${comment.lecture_content}</textarea>
            <br><br>
