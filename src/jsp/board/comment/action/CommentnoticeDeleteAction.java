...
public class CommentnoticeDeleteAction implements Action{
    ...
    public void getDeleteList(int no) {
        ...
        try {
            stmt =con.prepareStatement("SELECT comment_num FROM notice_comment WHERE parent = ?");
            stmt.setInt(1, no);
...
boolean result=dao.noticedelete(v); 
